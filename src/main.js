...
Vue.component('tags', {
  template: `
    <div>
      ...
      <section class="tag-details"><!--This is where I need to do the v-for. Perhaps a method in
        a computed property that refines the data displayed-->
        <slot></slot>
      </section>
    </div>
    `,
...
Vue.component('tag', {
  template: `<!--OR MAYBE A V-FOR HERE. DIV OR SECTION TAG THAT WRAPS THE ARTICLE TAGS.
  COMPUTED PROPERTY THAT FILTERS OUT ALL THE PROPERTIES-->
    <article v-show="isActive"><slot></slot></article><!--New tag inside the article?
    Should the v-for be inside the new tag? - Probably have a computed property (function) inside the new tag
    that executes on load and separates the object?-->
  `,
  ...
  data() {
    return {
      ...
      positions: [
        ...
        company_url: "https://sportytourist.com",
        location: "San Francisco, CA",
        job_title: "Developer",
        start_date: "10/2016",
        end_date: "10/2016",
